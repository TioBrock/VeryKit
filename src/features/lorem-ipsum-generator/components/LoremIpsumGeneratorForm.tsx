...
import { generateLoremIpsum, type LoremType } from "@/features/lorem-ipsum-generator/utils/generate";

export function LoremIpsumGeneratorForm() {
  const t = useTranslations("lorem-ipsum-generator");
  ...
  const handleGenerate = useCallback(() => {
    ...
    const text = generateLoremIpsum(count, type);
    setResult(text);
    setError(false);
    setCopied(false);
    setCopyError(false);
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-4 rounded-lg border border-border bg-card p-6">
          <div className="flex items-center justify-between">
            <label htmlFor="lorem-count" className="text-sm font-medium text-foreground">
              {t("count")}
            </label>
        ...
        {/* Result */}
        <div>
          <label htmlFor="lorem-result" className="mb-2 block text-sm font-medium text-foreground">
            {t("resultLabel")}
          </label>
          <textarea
            id="lorem-result"
